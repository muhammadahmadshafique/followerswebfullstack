  ...
  return (
    <div className="bgim">
      <div className="md:mx-[72px] mx-[12px]">
        ...
        <div className="flex justify-center md:justify-end my-[10px] md:my-[60px] items-center">
          <div className="rounded-[24px] p-[32px] w-[600px] bg-[#FFF]">
            <div className="space-y-[18px]">
              ...
              <div className="flex flex-col items-center md:items-start gap-y-3 md:flex-row  md:space-x-12 justify-between selection:items-center">
                <p className="text-[16px] whitespace-nowrap md:whitespace-normal tracking-[0.32px] font-[500] fcl">
      ...
      <div className="mt-[12px] md:pt-[0px]">
        {/* <hr
